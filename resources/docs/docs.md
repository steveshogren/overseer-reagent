...
* Update the connection parameters for the database in the `overseer.db.core` namespace of your application.
...
Request middleware functions are located under the `overseer.middleware` namespace.
